$(function(){
    ...
    submitBind($('#wordSForm button'),$('input[type="text"]'));
    $('#wordSForm button').click(function(){
        ...
        if(word.length == 0){
            ...
            word = word.join(' ');
            G_Port._ajax('insertCustomKeywords','post',true,'custom_keywords='+word+'&project_id='+parent.G_GameId,function(){
