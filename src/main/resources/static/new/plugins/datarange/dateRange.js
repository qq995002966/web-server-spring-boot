/**
 * Created by raynorchen on 2015/12/15.
 */
...
function pickerDateRange(inputId, options) {
    ...
    //根据不同主题需要初始化的变量
    this.mOpts.compareCss = this.mOpts.theme == 'ta' ? this.mOpts.compareCss :this.mOpts.selectCss
    ...
    $('#' + this.calendarId).css('z-index', 29999999);
    // 初始化目标地址的元素
